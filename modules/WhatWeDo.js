    ...
    <div className='section'>
        <div className='container d-flex d-flex-wrap d-justify-center'>
            ...
            <div ref={tabRef} className={`col-12 d-flex d-flex-wrap d-justify-space-between ${styles["type-tabs"]}`}>
                ...
                <h5 value="web" className='f-500 l-27 text-grey p-1 rounded-20' onClick={typeTabHandler}>Web Development</h5>
                <h5 value="digital" className='f-500 l-27 text-grey p-1 rounded-20' onClick={typeTabHandler}>Digital Marketing</h5>
                <h5 value="analytics" className='f-500 l-27 text-grey p-1 rounded-20' onClick={typeTabHandler}>Data Analyticis</h5>
                <h5 value="ui" className='f-500 l-27 text-grey p-1 rounded-20' onClick={typeTabHandler}>UI/UX designers</h5>
                <h5 value="app" className='f-500 l-27 text-grey p-1 rounded-20' onClick={typeTabHandler}>App Development</h5>
            </div>
